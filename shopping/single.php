                        ...
                        <div class="col-md-6">
                            <div class="product p-4">
                                ...
                                <form method="post" id="form-data">
                                    <div class="">
                                        <input value="<?php echo $product->id; ?>" type="text" name="pro_id" class="form-control">
                                    </div>
                                    <div class="">
                                        <input value="<?php echo $product->name; ?>" type="text" name="pro_name" class="form-control">
                                    </div>
                                    <div class="">
                                        <input value="<?php echo $product->image; ?>" type="text" name="pro_image" class="form-control">
                                    </div>
                                    <div class="">
                                        <input value="<?php echo $product->price; ?>" type="text" name="pro_price" class="form-control">
                                    </div>
                                    <div class="">
                                        <input value="1" type="text" name="pro_amount" class="form-control">
                                    </div>
                                    <div class="">
                                        <input value="<?php echo $product->file; ?>" type="text" name="pro_file" class="form-control">
                                    </div>
                                    <div class="">
                                        <input value="<?php echo $_SESSION['user_id'] ?>" type="text" name="user_id" class="form-control">
                                    </div>
